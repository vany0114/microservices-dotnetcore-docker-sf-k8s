        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 7, , 8]);
                        if (!(this.options.transport === HttpTransportType.WebSockets)) return [3 /*break*/, 2];
                    ...
                    case 7:
                        e_1 = _b.sent();
                        this.logger.log(LogLevel.Error, "Failed to start the connection: " + e_1);
                        this.connectionState = 2 /* Disconnected */;
                        this.transport = null;
                        throw e_1;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        e_2 = _a.sent();
                        this.logger.log(LogLevel.Error, "Failed to complete negotiation with the server: " + e_2);
                        throw e_2;
